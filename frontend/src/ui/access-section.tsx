          ...
          {accounts.map((account) => {
            ...
            return (
              ...
              >
                ...
                {account.role !== "admin" ? (
                  <Button
                    ...
                    onClick={async () => {
                      if (
                        !(await ask({
                          title: `Make ${account.username} the admin?`,
                          description: "You will become a tenant on the next request.",
                ...
                <Button variant="outline" size="sm" onClick={() => setPasswordResetFor(account)}>
                  Reset password
                </Button>
                <NativeSelect
